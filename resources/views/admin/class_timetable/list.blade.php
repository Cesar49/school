        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Buscar Horario</h3>
            </div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="{{ url('admin/class_timetable/list') }}" class="btn btn-success" style="margin-top: 30px;"> Limpiar</a>
                  </div>
                </div>
          ...
          <form action="{{ url('admin/class_timetable/add') }}" method="post">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Horario de Clases</h3>
              </div>
              <!-- /.card-header -->
